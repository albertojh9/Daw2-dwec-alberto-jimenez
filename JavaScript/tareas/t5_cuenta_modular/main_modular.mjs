// main.mjs
// Archivo principal que importa y utiliza la clase Cuenta
// Alumno: Alberto - 2º DAW

// Importamos la clase Cuenta desde el módulo cuenta.mjs
import { Cuenta } from './cuenta_modular.mjs';

/**
 * Función principal que ejecuta el programa de prueba
 */
function main() {
    console.log("=".repeat(50));
    console.log("PROGRAMA DE PRUEBA - CLASE CUENTA (VERSIÓN MODULAR)");
    console.log("=".repeat(50));
